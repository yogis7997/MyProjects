...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private int mTabViewImageViewId, mTabViewImageViewId1;
	...
	public void setRefreshistener(RefreshListener refreshListener) {
	...
	public void setCustomTabView(int layoutResId, int textViewId,
			int imageviewid, int customTabImg1) {
		mTabViewLayoutId = layoutResId;
		mTabViewTextViewId = textViewId;
		mTabViewImageViewId = imageviewid;
		mTabViewImageViewId1 = customTabImg1;
	}
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (mTabViewLayoutId != 0) {
				...
				tabImageView = (ImageView) tabView
						.findViewById(mTabViewImageViewId);
				tabImageView1 = (ImageView) tabView.findViewById(R.id.image);
			}
			...
			if (i == 0) {
				...
				// tabImageView1.setImageResource(View.GONE);
				...
				// tabImageView1.setImageResource(View.VISIBLE);
			}

			// tabTitleView.setTextColor(getResources().getColorStateList(
			// R.color.selector));
			tabTitleView.setTextColor(Color.WHITE);
			tabTitleView.setBackgroundResource(R.drawable.tv_bg_selector);
